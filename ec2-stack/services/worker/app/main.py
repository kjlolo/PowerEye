...
def write_telemetry(site_id: str, device_id: str, data: dict) -> None:
    ...
    point.field("battery_discharging_count", int(data.get("battery_discharging_count", 0) or 0))
    point.field("battery_charging_count", int(data.get("battery_charging_count", 0) or 0))
    point.field("battery_discharging_active", bool(data.get("battery_discharging_active", False)))
    ...
    point.field("power_supply_grid", bool(data.get("power_supply_grid", False)))
    point.field("power_supply_genset", bool(data.get("power_supply_genset", False)))
